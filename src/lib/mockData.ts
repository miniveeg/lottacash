import type { Timeframe, WalletStats } from './types'
...
export function getWalletByAddress(address: string): WalletStats | undefined {
  return BASE.find((w) => w.address === address)
}